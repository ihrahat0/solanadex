...
export const isLocal = () => typeof window !== 'undefined' && window.location.host.includes('vercel.app')
export const isDocumentVisible = () => isClient() && document.visibilityState === 'visible'
export const isProdEnv = () => isClient() && window.location.host.includes('vercel.app')
